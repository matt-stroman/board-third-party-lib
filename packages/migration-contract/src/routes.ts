...
export const maintainedApiRoutes: ReadonlyArray<MaintainedApiRoute> = [
  ...
  { method: "POST", path: "/developer/titles/{titleId}/releases/{releaseId}/publish", description: "Publish title release", access: "developer", authMode: "token-required" },
  ...
  { method: "POST", path: "/developer/titles/{titleId}/releases/{releaseId}/withdraw", description: "Withdraw title release", access: "developer", authMode: "token-required" },
